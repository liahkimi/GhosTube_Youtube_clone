...
app.use(logger);
app.use(express.urlencoded({ extended: true })); //express가 form의 value를 이해하도록 설치함(백엔드가 form에서 오는 값을 이해 할 수 있게)
app.use(express.json()); //백엔드가 form에서 받은 코멘트값을 이해하도록 설정함
//세션미들웨어
app.use(
  session({
